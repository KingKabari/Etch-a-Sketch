...
Etch-a-Sketch is a classic drawing toy reimagined in your browser. 
Create pixel art with your mouse by hovering over a dynamic grid—change grid sizes, experiment with random colors, and watch squares darken as you "draw" over them.
...
- **Black Mode:** Instantly draw in bold black. 
...
3. Click "Color Mode" for color drawing, "Black Mode" for black marker effect, or "Eraser" to clear squares.
4. Click "Change Grid Size" to adjust grid detail up to 100x100.
5. Click anywhere on the board to toggle between drawing and free movement.
...
## Credits
- Developed for The Odin Project/Foundations curriculum.
